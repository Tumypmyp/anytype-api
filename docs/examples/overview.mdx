...
- **[Save to Anytype (Browser Extension)](/docs/examples/community/lazjedi-save-to-anytype)** - ⭐ 33 stars
- **[Anytype Go SDK](/docs/examples/community/epheo-anytype-go)** - ⭐ 27 stars
...
- **[Anytype Go SDK](/docs/examples/community/epheo-anytype-go)** (⭐ 27) - A Go SDK for interacting with the Anytype API to manage spaces, objects, and perform searches. This library provides a feature-rich, fluent interface to integrate Anytype functionality into your Go applications
- **[Anytype Python Client](/docs/examples/community/beaucronin-anytype-python-client)** (⭐ 16) - A comprehensive Python client for the Anytype API with both synchronous and asynchronous support
...
- **[AnyTask](/docs/examples/community/Tumypmyp-any-task)** (⭐ 3) - A Cross-Platform Client for Anytype written with Rust and Dioxus

#### Extensions

- **[Save to Anytype (Browser Extension)](/docs/examples/community/lazjedi-save-to-anytype)** (⭐ 33) - Save important web pages with your selected text in Markdown format to Anytype. Lightweight and easy-to-use alternative web clipper.
